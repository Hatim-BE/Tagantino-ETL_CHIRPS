...
from config import setup_logging, DEFAULT_DATA_DIR, DEFAULT_MAX_FAILS
from src import download_chirps_data, process_files, upload_file_to_s3, upload_dir_to_s3
...
def main():
    ...
    if not args.csv_dir:
        args.csv_dir = f'{DEFAULT_DATA_DIR}/csv'
